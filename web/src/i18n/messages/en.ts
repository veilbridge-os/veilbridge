...
const en = {
  shell: {
    ...
    also: {
      ...
      staticRoutes:
        'static route, route, gateway, metric, routing table, another network, second router',
  ...
  // Static routes (#48), to the accepted artboards Rt-* (design task 07).
  rt: {
    title: 'Static routes',
    intro:
      'Needed when another network sits behind another router on your network — a second router, a VPN box to work, a lab. The router finds everything else by itself.',
    listTitle: 'Routes',
    add: 'Add route',
    colState: 'State',
    ...
    stateOk: 'working',
    stateOff: 'off',
    stateBad: 'not working',
    stateUnknown: 'not checked',
    via: 'via {gw}',
    direct: 'directly',
    metricN: 'metric {n}',
    v6: 'IPv6 — view only',
    whyDown: 'the connection “{iface}” is not up',
    whyGateway:
      'gateway {gw} is outside the network of “{iface}” ({net}) — the device does not use it',
    whyUnknown: 'the device does not use this route',
    unknownHint: 'A route in its own table — the panel does not check those against the device.',
    hidden: 'Has settings the panel does not show: {list} — change them in advanced mode',
    proof:
      '“Working” means the route is in the device’s routing table right now, not only in the settings.',
    emptyTitle: 'No static routes',
    empty:
      'Usually none are needed: the router sends everything to the internet through the provider and to the local network directly. A route is needed when another network sits behind another router on your network.',
    unsupported: 'This device’s routes cannot be managed from the panel',
    unsupportedHint: 'Routes exist and work — view and change them in advanced mode.',
    busyTitle: 'A previous change is being confirmed',
    ...
    remove: 'Remove',
    on: 'Route is on',
    dialogNew: 'Static route',
    dialogEdit: 'Route “{name}”',
    kind: 'Route type',
    kindNet: 'Route to a network',
    kindHost: 'Route to a host',
    netAddress: 'Network address',
    hostAddress: 'Host address',
    hostHint: 'One computer or server behind another router',
    mask: 'Mask',
    netHint: 'For example, 10.8.0.0 and /24 are the addresses 10.8.0.1–10.8.0.254.',
    gateway: 'Gateway',
    gatewayHint:
      'The address of the other router on your network that this network is behind. Empty — the network is reached directly.',
    iface: 'Connection',
    ifaceAuto: 'Automatically — by the gateway',
    advanced: 'More: metric',
    metric: 'Metric',
    metricHint: 'Lower wins when there are several routes to one network.',
    name: 'Name',
    cancel: 'Cancel',
    save: 'Save to draft',
    setMetric: 'Set metric {n}',
    hiddenPanel:
      'This route has settings the panel does not show yet: {list}. Such a route does not apply to all traffic, so it can only be changed in advanced mode, and the panel cannot check whether it works.',
    hiddenPanelHint: 'Switching off or removing it here leaves the hidden settings alone.',
    close: 'Close',
    switchOff: 'Switch off',
    switchOn: 'Switch on',
    hiddenKey: {
      table: 'its own routing table',
      source: 'source address',
      type: 'route type',
      onlink: 'gateway without a network check',
      mtu: 'MTU',
      other: 'other settings',
    },
    bad: {
      target: 'Not a network or address the device accepts, or this network is already routed',
      clash:
        'This network is already routed with this metric. The network service would take that route over and remove it together with this one — give this one another metric',
      gateway:
        'The gateway has to be on the network of the chosen connection — otherwise the device accepts the route and never uses it',
      interface: 'Choose a connection, or give a gateway to pick it by',
      metric: 'A metric is a number from 0 to 65535',
      name: 'A name cannot contain quotes, backslashes or line breaks',
      id: 'This route can only be switched on and off or removed here',
    },
  },
  fw: {
    title: 'Firewall',
